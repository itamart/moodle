...
echo $preset->process_action($action, compact('shortname', 'fullname', 'dataform', 'userid', 'file', 'course', 'sesskey'));
...
helpbutton('savepreset', '', 'dataform');
echo '</td><td>';
$options = new object();
...
helpbutton('importfromfile', '', 'dataform');
echo '</td><td>';
...
foreach ($presets as $id => $preset) {
    ...
    $dellink = '';
    if ($preset->user_id > 0 and ($preset->user_id == $USER->id || has_capability('mod/dataform:manageuserpresets', $context))) {
