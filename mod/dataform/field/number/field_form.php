...
class mod_dataform_field_number_form extends mod_dataform_field_form {
    ...
    function mod_dataform_field_number_form($field) {
    ...
    //-------------------------------------------------------------------------------
        ...
        $fieldwidthgrprules = array();
        $fieldwidthgrprules['param2'][] = array(null, 'numeric', null, 'client');
        $mform->addGroupRule('fieldwidthgrp', $fieldwidthgrprules);
